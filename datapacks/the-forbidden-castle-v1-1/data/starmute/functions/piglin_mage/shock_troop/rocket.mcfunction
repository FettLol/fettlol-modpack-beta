...
data merge entity @s {FallFlying:0b,NoGravity:0b}
...
tag @s add leaping
tag @s add used_leap
execute as @e[type=area_effect_cloud,tag=select] at @s run function starmute:piglin_mage/shock_troop/leap_towards
